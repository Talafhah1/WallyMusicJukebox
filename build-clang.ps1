#!/usr/bin/env pwsh
# PowerShell build script for WallyMusicJukebox DLL using Clang

Write-Host "====================================" -ForegroundColor Cyan
Write-Host "Building WallyMusicJukebox DLL (Clang)" -ForegroundColor Cyan
Write-Host "====================================" -ForegroundColor Cyan
...
try {
    ...
    Write-Host "Please install LLVM/Clang or use Visual Studio's clang-cl" -ForegroundColor Yellow
    Write-Host "  LLVM: https://releases.llvm.org/" -ForegroundColor Yellow
    Write-Host "  Or install 'C++ Clang tools for Windows' in Visual Studio" -ForegroundColor Yellow
    exit 1
}
...
try {
    ...
    Write-Host "Or use: winget install Ninja-build.Ninja" -ForegroundColor Yellow
    exit 1
}
...
Write-Host "  Compiler: $clangVersion" -ForegroundColor White
